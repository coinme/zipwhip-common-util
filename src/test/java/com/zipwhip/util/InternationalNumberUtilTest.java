...
public class InternationalNumberUtilTest {
    ...
    public void testGetE164Number() throws Exception {
        ...
        // This case show us re-internationalizing a 'Zipwhip Domestic' number for an international user
        // The assumption being that Caron may have stripped the '+1' and it is up to clients to correct this
        assertEquals("+12069308451", InternationalNumberUtil.getE164Number("2069308451", "PH"));
